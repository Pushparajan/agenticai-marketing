        ...
        "linkedin": [
            {
                ...
                "notable_tactics": [
                    "Lead gen forms with 3 fields max",
                    "Carousel ads showcasing key statistics",
            ...
            },
            {
                ...
                "ad_copy_examples": [
                    "Your buyers don't want to fill out forms. Give them a conversation instead.",
                    "Drift customers close deals 40% faster. See how.",
                ],
                "targeting": "Sales and Marketing leaders at enterprise B2B companies",
                "estimated_spend": "$30K-$50K/month",
                "notable_tactics": [
                    "Video testimonial ads from recognizable brands",
                    "Interactive ROI calculator as lead magnet",
                    "Sequential messaging across awareness-consideration-decision stages",
                ],
            },
        ],
        "paid_search": [{
