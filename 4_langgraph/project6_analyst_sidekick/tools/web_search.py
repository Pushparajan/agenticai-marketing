    ...
    "cac": [
        {
            ...
            "snippet": (
                "Median SaaS CAC rose 18% YoY in 2025 but has started to "
                "stabilise in Q1 2026 at $347 for SMB and $4,200 for enterprise. "
                "Organic content and partner referrals remain the most efficient "
                "acquisition channels with CAC payback under 6 months."
            ),
        ...
        },
        {
            ...
            "snippet": (
                "Companies deploying AI-based lead scoring models saw an "
                "average 30% reduction in customer acquisition cost over 12 "
                "months by focusing spend on high-intent prospects."
            ),
    ...
    "email": [
        {
            ...
            "snippet": (
                "Average email open rates across industries held steady at "
                "28.7% in Q1 2026.  Personalised subject lines lifted open "
                "rates by 14%.  B2B SaaS newsletters saw the highest CTR at "
                "4.2%, while promotional sends averaged 1.8%."
            ),
        ...
        },
        {
            ...
            "snippet": (
                "Marketers using behavioural segmentation report 2x higher "
                "click-through rates compared to demographic-only segments. "
                "Product-usage signals and intent data are the new gold standard."
            ),
    ...
    "pipeline": [
        {
            ...
            "snippet": (
                "Organic search generated 33% of total pipeline in Q1 2026, "
                "followed by LinkedIn Ads (23%) and email nurture (17%).  "
                "Paid social (Facebook / Twitter) contributed just 2.6% of "
                "qualified pipeline despite accounting for 12% of spend."
            ),
        ...
        },
        {
            ...
            "snippet": (
                "Linear and W-shaped attribution models provide the most "
                "balanced view of pipeline contribution.  First-touch models "
                "over-credit content marketing while last-touch models over-"
                "credit sales outreach."
            ),
    ...
    "martech": [
        {
            ...
            "snippet": (
                "The 2026 MarTech landscape shrank to 9,200 solutions (from "
                "11,038 in 2024) as consolidation accelerated.  AI-native "
                "platforms — autonomous campaign builders, conversational "
                "analytics, and predictive CDPs — are the fastest-growing "
                "category at 47% YoY."
            ),
        ...
        },
        {
            ...
            "snippet": (
                "Gartner's 2026 CMO Spend Survey found that marketing "
                "technology now accounts for 28.8% of the total marketing "
                "budget, overtaking paid media (26.1%) for the first time."
            ),
    ...
    "default": [
        {
            ...
            "snippet": (
                "Salesforce's annual survey of 6,000+ marketers reveals that "
                "72% now use generative AI in at least one workflow.  "
                "Personalisation at scale and first-party data strategies "
                "are the top two priorities for the year."
            ),
        ...
        },
        {
            ...
            "snippet": (
                "Only 11% of marketing organisations have reached 'predictive' "
                "maturity in their analytics capability.  Most remain at the "
                "'descriptive' stage, relying on dashboards rather than "
        ...
        },
        {
            ...
            "snippet": (
                "With Chrome finally removing third-party cookies in Q2 2026, "
                "marketers must accelerate first-party data collection. "
                "Contextual advertising spend is projected to grow 35% YoY."
            ),
